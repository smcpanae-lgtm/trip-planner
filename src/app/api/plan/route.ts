...
9. 昼食・夕食について:
   ...
   - 希望場所が指定されている場合（PA以外）: **必ずその指定場所の周辺エリアで食事スポットを設定すること。出発地や自宅付近ではなく、指定された場所の近くで探すこと**
...
10. 食事スポットの注意:
   ...
   - **希望場所が指定されていれば必ずその場所の周辺で食事スポットを設定すること（例: 「軽井沢周辺」なら軽井沢駅付近の座標を使用）。出発地や帰着地の近くは不可**
