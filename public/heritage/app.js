const translations = {
  ...
  "zh-CN": {
    ...
    prevPage: "上一页",
    nextPage: "下一页",
    profileNameLabel: "用户名称",
    profileNamePlaceholder: "例如：N.K. / 旅行者A",
    profileNameNote: "会保存在浏览器内，并包含于备份中。",
    exportRecords: "不含照片的备份",
    localNotice: "访问记录与照片仅保存在此浏览器内。若在同一设备、同一浏览器再次访问，先前保存的内容仍可继续使用。备份功能是将数据写出为JSON文件至您自己的设备，方便在更换电脑或改用其他浏览器时还原记录；本站运营方无法查看或获取备份内容。",
    unofficialNotice: "本站并非UNESCO/WHC官方网站。世界遗产的详细信息请参阅各官方页面。",
    accuracyNotice: "本站信息是根据公开数据整理的，并不保证其时效性与完整性。规划旅行或需要正式确认时，请参阅各官方页面。",
    rightsNotice: "本站使用世界遗产名称、国家、列入年份等事实信息，未使用UNESCO/WHC官方的说明文字、照片或标志。站内代表图片为独立生成的示意图像。国旗图标使用flag-icons（MIT授权）。",
    memorialNotice: "当您访问完某地区内的所有世界遗产，或征服全部世界遗产时，系统会根据浏览器内的记录显示纪念画面。",
    backupPhotoCaution: "使用同一浏览器再次访问时，照片与记录仍会保留。如需更换电脑或改用其他浏览器，请通过备份文件还原。“不含照片的备份”不会包含已上传的照片。",
    travelJournalBannerKicker: "AI旅行日记生成器",
    travelJournalBannerTitle: "利用已保存的世界遗产照片记录，制作社交媒体文案与封面图片",
    travelJournalBannerBody: "载入访问日期、照片与备注，方便旅行后整理回忆。",
    travelJournalBannerAction: "前往AI旅行日记"
  },
  "zh-TW": {
    eyebrow: "私人旅行紀錄",
    appTitle: "世界遺產護照",
    ...
    prevPage: "上一頁",
    nextPage: "下一頁",
    profileNameLabel: "使用者名稱",
    profileNamePlaceholder: "例如：N.K. / 旅人A",
    profileNameNote: "會保存在瀏覽器內，並包含於備份中。",
    exportRecords: "不含照片的備份",
    localNotice: "造訪紀錄與照片僅保存在此瀏覽器內。若在同一裝置、同一瀏覽器再次造訪，先前保存的內容仍可繼續使用。備份功能是將資料寫出為JSON檔案至您自己的裝置，方便在更換電腦或改用其他瀏覽器時還原紀錄；本站營運方無法檢視或取得備份內容。",
    unofficialNotice: "本站並非UNESCO/WHC官方網站。世界遺產的詳細資訊請參閱各官方頁面。",
    accuracyNotice: "本站資訊係根據公開資料整理，並不保證其即時性與完整性。規劃旅行或需要正式確認時，請參閱各官方頁面。",
    rightsNotice: "本站使用世界遺產名稱、國家、登錄年份等事實資訊，未使用UNESCO/WHC官方的說明文字、照片或標誌。站內代表圖片為獨立生成的示意圖像。國旗圖示使用flag-icons（MIT授權）。",
    memorialNotice: "當您造訪完某地區內的所有世界遺產，或征服全部世界遺產時，系統會根據瀏覽器內的紀錄顯示紀念畫面。",
    backupPhotoCaution: "使用同一瀏覽器再次造訪時，照片與紀錄仍會保留。若要更換電腦或改用其他瀏覽器，請透過備份檔還原。「不含照片的備份」不會包含已上傳的照片。",
    travelJournalBannerKicker: "AI旅遊日記產生器",
    travelJournalBannerTitle: "運用已保存的世界遺產照片紀錄，製作社群貼文與封面圖片",
    travelJournalBannerBody: "載入造訪日期、照片與備註，方便旅行後整理回憶。",
    travelJournalBannerAction: "前往AI旅遊日記"
  },
  ko: {
    eyebrow: "개인 여행 기록",
    appTitle: "세계유산 패스포트",
